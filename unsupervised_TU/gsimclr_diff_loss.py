...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs+1):
        ...
        for data in dataloader:
            ...
            # print(x_aug)
            if loss_name=='JSD':
                loss = model.loss_cal_JSD(x, x_aug)
            elif loss_name=='DIS':
                loss = model.loss_cal_dis(x, x_aug)
            print(loss)
    ...
    torch.save(model.state_dict(),'/data0/BigPlatform/mhn/GraphCL-master/unsupervised_TU/model/gsimclr_{}_{}_{}.pth'.format(args.DS,args.aug,loss_name))
