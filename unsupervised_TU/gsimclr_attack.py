...
if __name__ == '__main__':
    ...
    # ['state_dict']
    model.load_state_dict(torch.load('/data0/BigPlatform/mhn/GraphCL-master/unsupervised_TU/model/gsimclr_{}_{}_{}.pth'.format(args.DS,args.aug,args.num_gc_layers),map_location=f"cuda:0"))
